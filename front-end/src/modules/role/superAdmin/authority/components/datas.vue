<template>
  <div>
    <div class="clearflex" style="margin-bottom: 25px">
      <my-button @click="authDataEnter" class="fl-right" type="primary">确定</my-button>
      <my-button @click="all" class="fl-left" type="primary">全选</my-button>
      <my-button @click="self" class="fl-left" type="primary">本角色</my-button>
      <my-button @click="selfAndChildren" class="fl-left" type="primary">本角色及子角色</my-button>
    </div>
    <el-checkbox-group v-model="dataAuthorityId" @change="selectAuthority">
      <el-checkbox v-for="(item,key) in authoritys" :key="key" :label="item" style="margin-bottom: 20px">{{ item.authorityName }}</el-checkbox>
    </el-checkbox-group>
...
<script setup>
import { setDataAuthority } from '@/modules/role/actions/authority'
