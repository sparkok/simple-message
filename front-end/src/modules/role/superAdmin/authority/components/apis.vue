<template>
  <div>
    <div class="clearflex">
      <my-button @click="authApiEnter" class="fl-right" type="primary">确定</my-button>
    </div>
    <el-tree
      ref="apiTree"
      :data="apiTreeData"
...
<script setup>
import { getAllApis } from '@/modules/role/actions/api'
import { UpdateCasbin, getPolicyPathByAuthorityId } from '@/modules/role/actions/casbin'
import { ref } from 'vue'
