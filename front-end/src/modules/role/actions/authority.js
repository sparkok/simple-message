...
export const getAuthorityList = (data) => {
  return service({
    url: '/role/authority/getAuthorityList',
    method: 'post',
    data
  })
}
...
export const deleteAuthority = (data) => {
  return service({
    url: '/role/authority/deleteAuthority',
    method: 'post',
    data
  })
}
...
export const createAuthority = (data) => {
  return service({
    url: '/role/authority/createAuthority',
    method: 'post',
    data
  })
}
...
export const copyAuthority = (data) => {
  return service({
    url: '/role/authority/copyAuthority',
    method: 'post',
    data
  })
}
...
export const setDataAuthority = (data) => {
  return service({
    url: '/role/authority/setDataAuthority',
    method: 'post',
    data
  })
}
...
export const updateAuthority = (data) => {
  return service({
    url: '/role/authority/updateAuthority',
    method: 'put',
    data
  })
}
