...
export const deleteSysOperationRecord = (data) => {
  return service({
    url: '/role/sysOperationRecord/deleteSysOperationRecord',
    method: 'delete',
    data
  })
}
...
export const deleteSysOperationRecordByIds = (data) => {
  return service({
    url: '/role/sysOperationRecord/deleteSysOperationRecordByIds',
    method: 'delete',
    data
  })
}
...
export const getSysOperationRecordList = (params) => {
  return service({
    url: '/role/sysOperationRecord/getSysOperationRecordList',
    method: 'get',
    params
  })
}
