<template>
  <div>
    ...
    <el-dialog custom-class="fontWeight" 
    ...
    >
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button
            size="small"
            class="new-button confirm-button"
            @click="savePassword"
          >确 定</el-button>
          <el-button
            size="small"
    ...
    <el-dialog custom-class="fontWeight"  v-model="changePhoneFlag" title="绑定手机" width="600px">
      <el-form :model="phoneForm">
        ...
        <el-form-item label="验证码" label-width="120px">
          <div class="code-box">
            ...
            <el-button size="small" class="common-button" :disabled="time>0" @click="getCode">{{ time>0?`(${time}s)后重新获取`:'获取验证码' }}</el-button>
          </div>
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <el-dialog custom-class="fontWeight"  v-model="changeEmailFlag" title="绑定邮箱" width="600px">
      <el-form :model="emailForm">
        ...
        <el-form-item label="验证码" label-width="120px">
          <div class="code-box">
            ...
            <el-button size="small" class="common-button" :disabled="emailTime>0" @click="getEmailCode">{{ emailTime>0?`(${emailTime}s)后重新获取`:'获取验证码' }}</el-button>
          </div>
        </el-form-item>
      </el-form>
      <template #footer>
...
import { setSelfInfo, changePassword } from '@/modules/role/actions/user.js'
