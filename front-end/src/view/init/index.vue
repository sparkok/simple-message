    ...
    <div class="init_page_panle">
      <div v-if="hello < 2" id="hello" :class="[hello < 1 ? 'slide-in-fwd-top' : 'slide-out-right']" class="hello" >
        <div>
          ...
          <p class="init_btn">
            <el-button class="common-button" @click="showNext">
              我已确认
            </el-button>
          </p>
        </div>
        ...
        <el-form ref="formRef" :model="form" label-width="100px">
          ...
          <el-form-item>
            <div style="text-align: right">
              <el-button class="common-button" @click="onSubmit">立即初始化</el-button>
            </div>
          </el-form-item>
        </el-form>
      </div>
...
<script setup>
import { initDB } from '@/modules/role/actions/initdb'
