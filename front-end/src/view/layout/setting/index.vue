        ...
        <div class="setting_card">
          <div class="setting_content">
            <div class="theme-box">
              ...
              <div class="item" @click="changeMode('lightGreen')">
                <div class="item-top">
                  <el-icon v-if="userStore.mode === 'lightGreen'" class="check">
                    <check />
                  </el-icon>
                  <img src="https://gw.alipayobjects.com/zos/antfincdn/XwFOFbLkSM/LCkqqYNmvBEbokSDscrm.svg">
                </div>
              ...
              <div class="item" @click="changeMode('green')">
                <div class="item-top">
                  <el-icon v-if="userStore.mode === 'green'" class="check">
                    <check />
                  </el-icon>
                  <img src="https://gw.alipayobjects.com/zos/antfincdn/XwFOFbLkSM/LCkqqYNmvBEbokSDscrm.svg">
                </div>
